...
export default interface Resources {
  ...
  "dialogs": {
    ...
    "rStudio": {
      ...
      "run": "运行并预览",
      "running": "正在运行脚本…",
      "scope": "在浏览器中运行独立 R 脚本，并对名为 p 的 ggplot2 对象调整标题、坐标轴、主题、字号和图例。原脚本保留，修改可撤销，支持 PNG、PDF 和带样式的 R 脚本导出。暂不支持本地数据文件、其他 R 包或直接拖动图中元素。首次使用需下载 R 与 ggplot2；应用不会上传脚本，但脚本自己发起的网络请求不在此保证内。",
      "source": "R 脚本（将图保存为 p）",
      "style": "图表样式",
      "theme": "主题",
      "title": "R / ggplot2 实验版",
    ...
    "site": {
      ...
      "rBoundary": "R 入口专注主题与样式调整，暂不支持逐对象拖拽。",
