...
export default interface Resources {
  ...
  "dialogs": {
    ...
    "playground": {
      ...
      "desktopNote": "{{product}} 在线版复用原项目的编辑引擎。独立桌面安装包尚未发布。",
      "downloadDesktop": "桌面版进度",
    ...
    "site": {
      ...
      "desktopBody": "{{product}} 的 Windows .exe 与 macOS .dmg 安装包正在筹备，尚未发布。",
      "desktopNote": "目前请使用在线体验。桌面版发布后，这里会提供经过验证的安装包与平台说明。",
      "desktopTitle": "桌面版进度",
